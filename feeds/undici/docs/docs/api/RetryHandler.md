...
Extends: [`Dispatch.DispatchOptions`](feeds/undici/docs/docs/api/Dispatcher.md#parameter-dispatchoptions).
...
- **handler** Extends [`Dispatch.DispatchHandlers`](feeds/undici/docs/docs/api/Dispatcher.md#dispatcherdispatchoptions-handler) (required) - Handler function to be called after the request is successful or the retries are exhausted.
