...
It accepts the same arguments as the [`RedirectHandler` constructor](feeds/undici/docs/docs/api/RedirectHandler.md).
...
It accepts the same arguments as the [`RetryHandler` constructor](feeds/undici/docs/docs/api/RetryHandler.md).
...
Header arguments such as `options.headers` in [`Client.dispatch`](feeds/undici/docs/docs/api/Client.md#clientdispatchoptions-handlers) can be specified in three forms:
...
Response headers will derive a `host` from the `url` of the [Client](feeds/undici/docs/docs/api/Client.md#class-client) instance if no `host` header was previously specified.
